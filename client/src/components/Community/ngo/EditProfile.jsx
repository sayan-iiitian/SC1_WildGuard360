    ...
    try {
      ...
      const res = await apiRequest({
        ...
        data: {
          ...
          location,
          profession,
          profileUrl: uri ? uri : profileImage,
        },
        method: "PUT",
        token: user?.token,
      });
    ...
    <>
      <div className="fixed z-50 inset-0 overflow-y-auto">
        <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          &#8203;
          <div
            className="inline-block align-bottom bgcolortailwind rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
            role="dialog"
            aria-modal="true"
            aria-labelledby="modal-headline"
          >
